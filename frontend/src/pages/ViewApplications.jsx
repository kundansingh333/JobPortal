            ...
            {viewApplicationsPageData.map((applicant, index) => (
              <tr key={index} className="text-gray-700 border-b">
                ...
                <td className="py-2 px-4  text-center flex">
                  <img
                    className="w-12 h-12 mr-3 rounded-full max-sm:hidden"
                ...
                <td className="py-2 px-4  relative">
                  <div className="relative inline-block text-left group">
                    ...
                    <div className="z-10 hidden absolute right-0 md:left-0 top-0 mt-2 w-32 border bg-white border-gray-200 rounded shadow group-hover:block">
